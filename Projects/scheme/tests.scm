...
(define MUFUNCTION (mu (x) (* x y) ))
;MUFUNCTION

(define g (lambda (x y) (MUFUNCTION (+ x y))))
;g

(g 2 8)
; expect 80

(define (peeeeenta x) (* x x x x x))
; expect peeeeenta
...
(cddr '(1 3 5 6 7 8 2018 ))
;expect(5 6 7 8 2018)

(define s (list 1 1 2 3 5 8))
;expect s
...
(begin (define x 1) (* 2018 2019) x)
; expect 1

(equal? '(2018 . (2019 . 1819)) (cons 2018 (cons 2019 (cons 1819 nil))))
; expect #f

(equal? '(2018 . (2019 . 1819)) (cons 2018 (cons 2019 1819)))
; expect #t
